...
abstract class _PermissionDenied implements FirestoreFailure {
...
abstract class _TooManyRequests implements FirestoreFailure {
...
/// @nodoc
class __$NotFoundCopyWithImpl<$Res> extends _$FirestoreFailureCopyWithImpl<$Res>
...
abstract class _NotFound implements FirestoreFailure {
...
class _$_InvalidCredentials implements _InvalidCredentials {
  ...
  @override
  String toString() {
    return 'FirestoreFailure.invalidCredentials()';
  }
...
abstract class _InvalidCredentials implements FirestoreFailure {
...
abstract class _EmailAlreadyInUse implements FirestoreFailure {
...
abstract class _UserNotFound implements FirestoreFailure {
...
class _$_WeakPassword implements _WeakPassword {
  ...
  @override
  String toString() {
    return 'FirestoreFailure.weakPassword()';
  }
...
abstract class _WeakPassword implements FirestoreFailure {
...
class _$_OperationNotAllowed implements _OperationNotAllowed {
  ...
  @override
  String toString() {
    return 'FirestoreFailure.operationNotAllowed()';
  }
...
abstract class _OperationNotAllowed implements FirestoreFailure {
